...
int32_t
employee_entry_comparator::compare(const std::pair<const int32_t*, const employee*>* lhs,
...
int32_t
employee_entry_key_comparator::compare(const std::pair<const int32_t*, const employee*>* lhs,
                                       const std::pair<const int32_t*, const employee*>* rhs) const
{
...
int32_t
hz_serializer<examples::employee>::get_factory_id()
{
    return 666;
}

int32_t
hz_serializer<examples::employee>::get_class_id()
{
    return 2;
}

void
hz_serializer<examples::employee>::write_portable(const examples::employee& object,
...
examples::employee
hz_serializer<examples::employee>::read_portable(portable_reader& reader)
{
...
int32_t
hz_serializer<examples::employee_entry_comparator>::get_factory_id()
{
    return static_cast<int32_t>(1);
}

int32_t
hz_serializer<examples::employee_entry_comparator>::get_class_id()
{
    return 4;
}
