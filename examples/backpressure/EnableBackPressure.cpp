...
{
    static int32_t get_factory_id() noexcept { return 666; }

    static int32_t get_class_id() noexcept { return 8; }

    static void write_data(const WaitMultiplierProcessor& object,
    ...
    static WaitMultiplierProcessor read_data(
...
main()
{
     ...
     * a new invocation comes in, then hazelcast will throw hazelcast_overload <p/> By default it is
     ...
     * <code>hazelcast_overload</code> is thrown immediately without any waiting. This is the
     * default value.
     * </p>
     *
