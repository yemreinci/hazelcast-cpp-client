...
public:
    ...
    bool operator!=(const Member& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const Response& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const ServerException& rhs) const { return !(*this == rhs); }
