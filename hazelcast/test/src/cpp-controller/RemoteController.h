...
public:
    ...
    virtual bool exit() = 0;
    virtual void createCluster(Cluster& _return,
                               const std::string& hzVersion,
                               const std::string& xmlconfig) = 0;
    virtual void createClusterKeepClusterName(Cluster& _return,
                                              const std::string& hzVersion,
                                              const std::string& xmlconfig) = 0;
    ...
    virtual void mergeMemberToCluster(Cluster& _return,
                                      const std::string& clusterId,
                                      const std::string& memberId) = 0;
    virtual void executeOnController(Response& _return,
                                     const std::string& clusterId,
                                     const std::string& script,
                                     const Lang::type lang) = 0;
};
...
{
public:
    RemoteControllerIfSingletonFactory(const ::std::shared_ptr<RemoteControllerIf>& iface)
      : iface_(iface)
    {}
...
public:
    ...
    void createCluster(Cluster& /* _return */,
                       const std::string& /* hzVersion */,
                       const std::string& /* xmlconfig */)
    {
        return;
    }
    void createClusterKeepClusterName(Cluster& /* _return */,
                                      const std::string& /* hzVersion */,
                                      const std::string& /* xmlconfig */)
    {
        return;
    }
    void startMember(Member& /* _return */, const std::string& /* clusterId */) { return; }
    ...
    void mergeMemberToCluster(Cluster& /* _return */,
                              const std::string& /* clusterId */,
                              const std::string& /* memberId */)
    {
        return;
    }
    void executeOnController(Response& /* _return */,
                             const std::string& /* clusterId */,
                             const std::string& /* script */,
...
public:
    ...
    bool operator==(const RemoteController_ping_args& /* rhs */) const { return true; }
    bool operator!=(const RemoteController_ping_args& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const RemoteController_ping_result& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator==(const RemoteController_clean_args& /* rhs */) const { return true; }
    bool operator!=(const RemoteController_clean_args& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const RemoteController_clean_result& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator==(const RemoteController_exit_args& /* rhs */) const { return true; }
    bool operator!=(const RemoteController_exit_args& rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const RemoteController_exit_result& rhs) const { return !(*this == rhs); }
...
public:
    RemoteController_createClusterKeepClusterName_args(
      const RemoteController_createClusterKeepClusterName_args&);
    RemoteController_createClusterKeepClusterName_args& operator=(
      const RemoteController_createClusterKeepClusterName_args&);
    RemoteController_createClusterKeepClusterName_args()
      : hzVersion()
      , xmlconfig()
...
public:
    RemoteController_createClusterKeepClusterName_result(
      const RemoteController_createClusterKeepClusterName_result&);
    RemoteController_createClusterKeepClusterName_result& operator=(
      const RemoteController_createClusterKeepClusterName_result&);
    RemoteController_createClusterKeepClusterName_result() {}
...
public:
    ...
    bool operator!=(const RemoteController_startMember_args& rhs) const { return !(*this == rhs); }
...
public:
    ...
    RemoteController_shutdownMember_result& operator=(
...
public:
    ...
    RemoteController_terminateMember_result& operator=(
...
public:
    ...
    bool operator!=(const RemoteController_resumeMember_args& rhs) const { return !(*this == rhs); }
...
public:
    ...
    RemoteController_shutdownCluster_result& operator=(
...
public:
    ...
    RemoteController_terminateCluster_args& operator=(
...
public:
    ...
    RemoteController_terminateCluster_result& operator=(
...
public:
    ...
    RemoteController_splitMemberFromCluster_args& operator=(
      const RemoteController_splitMemberFromCluster_args&);
    RemoteController_splitMemberFromCluster_args()
      : memberId()
    {}
...
public:
    RemoteController_splitMemberFromCluster_result(
      const RemoteController_splitMemberFromCluster_result&);
    RemoteController_splitMemberFromCluster_result& operator=(
      const RemoteController_splitMemberFromCluster_result&);
    RemoteController_splitMemberFromCluster_result() {}
...
public:
    ...
    RemoteController_mergeMemberToCluster_args& operator=(
      const RemoteController_mergeMemberToCluster_args&);
...
public:
    RemoteController_mergeMemberToCluster_result(
      const RemoteController_mergeMemberToCluster_result&);
    RemoteController_mergeMemberToCluster_result& operator=(
      const RemoteController_mergeMemberToCluster_result&);
    RemoteController_mergeMemberToCluster_result() {}
...
public:
    ...
    RemoteController_executeOnController_args& operator=(
      const RemoteController_executeOnController_args&);
...
public:
    ...
    RemoteController_executeOnController_result& operator=(
      const RemoteController_executeOnController_result&);
...
public:
    ...
    RemoteControllerClient(std::shared_ptr<::apache::thrift::protocol::TProtocol> iprot,
...
public:
    ...
    void createClusterKeepClusterName(Cluster& _return,
                                      const std::string& hzVersion,
                                      const std::string& xmlconfig);
    void send_createClusterKeepClusterName(const std::string& hzVersion,
                                           const std::string& xmlconfig);
    ...
    void executeOnController(Response& _return,
                             ...
                             const std::string& script,
                             const Lang::type lang);
    void send_executeOnController(const std::string& clusterId,
                                  const std::string& script,
                                  const Lang::type lang);
...
private:
    typedef void (RemoteControllerProcessor::*ProcessFunction)(
      int32_t,
    ...
    void process_ping(int32_t seqid,
                      ...
                      ::apache::thrift::protocol::TProtocol* oprot,
                      void* callContext);
    void process_clean(int32_t seqid,
                       ::apache::thrift::protocol::TProtocol* iprot,
                       ::apache::thrift::protocol::TProtocol* oprot,
                       void* callContext);
    void process_exit(int32_t seqid,
                      ::apache::thrift::protocol::TProtocol* iprot,
                      ::apache::thrift::protocol::TProtocol* oprot,
                      void* callContext);
    void process_createCluster(int32_t seqid,
                               ::apache::thrift::protocol::TProtocol* iprot,
                               ::apache::thrift::protocol::TProtocol* oprot,
                               void* callContext);
    void process_createClusterKeepClusterName(int32_t seqid,
                                              ::apache::thrift::protocol::TProtocol* iprot,
                                              ::apache::thrift::protocol::TProtocol* oprot,
                                              void* callContext);
    void process_startMember(int32_t seqid,
                             ::apache::thrift::protocol::TProtocol* iprot,
                             ::apache::thrift::protocol::TProtocol* oprot,
                             void* callContext);
    void process_shutdownMember(int32_t seqid,
                                ::apache::thrift::protocol::TProtocol* iprot,
                                ::apache::thrift::protocol::TProtocol* oprot,
                                void* callContext);
    void process_terminateMember(int32_t seqid,
                                 ::apache::thrift::protocol::TProtocol* iprot,
                                 ::apache::thrift::protocol::TProtocol* oprot,
                                 void* callContext);
    void process_suspendMember(int32_t seqid,
                               ::apache::thrift::protocol::TProtocol* iprot,
                               ::apache::thrift::protocol::TProtocol* oprot,
                               void* callContext);
    void process_resumeMember(int32_t seqid,
                              ::apache::thrift::protocol::TProtocol* iprot,
                              ::apache::thrift::protocol::TProtocol* oprot,
                              void* callContext);
    void process_shutdownCluster(int32_t seqid,
                                 ::apache::thrift::protocol::TProtocol* iprot,
                                 ::apache::thrift::protocol::TProtocol* oprot,
                                 void* callContext);
    void process_terminateCluster(int32_t seqid,
                                  ::apache::thrift::protocol::TProtocol* iprot,
                                  ::apache::thrift::protocol::TProtocol* oprot,
                                  void* callContext);
    void process_splitMemberFromCluster(int32_t seqid,
                                        ::apache::thrift::protocol::TProtocol* iprot,
                                        ::apache::thrift::protocol::TProtocol* oprot,
                                        void* callContext);
    void process_mergeMemberToCluster(int32_t seqid,
                                      ::apache::thrift::protocol::TProtocol* iprot,
                                      ::apache::thrift::protocol::TProtocol* oprot,
                                      void* callContext);
    void process_executeOnController(int32_t seqid,
                                     ::apache::thrift::protocol::TProtocol* iprot,
                                     ::apache::thrift::protocol::TProtocol* oprot,
                                     void* callContext);
...
public:
      ...
      : iface_(iface)
    {
        ...
        process_map_["createClusterKeepClusterName"] =
        ...
        process_map_["splitMemberFromCluster"] =
          &RemoteControllerProcessor::process_splitMemberFromCluster;
        process_map_["mergeMemberToCluster"] =
          &RemoteControllerProcessor::process_mergeMemberToCluster;
        process_map_["executeOnController"] =
          &RemoteControllerProcessor::process_executeOnController;
    }
...
{
public:
    RemoteControllerMultiface(std::vector<std::shared_ptr<RemoteControllerIf>>& ifaces)
      : ifaces_(ifaces)
    {}
...
protected:
    ...
    void add(::std::shared_ptr<RemoteControllerIf> iface) { ifaces_.push_back(iface); }
...
{
public:
    RemoteControllerConcurrentClient(
...
public:
    ...
    void createClusterKeepClusterName(Cluster& _return,
                                      const std::string& hzVersion,
                                      const std::string& xmlconfig);
    int32_t send_createClusterKeepClusterName(const std::string& hzVersion,
                                              const std::string& xmlconfig);
    ...
    void executeOnController(Response& _return,
                             ...
                             const std::string& script,
                             const Lang::type lang);
    int32_t send_executeOnController(const std::string& clusterId,
                                     const std::string& script,
                                     const Lang::type lang);
