...
struct hz_serializer<test::EmployeeEntryKeyComparator> : public identified_data_serializer
{
    ...
    static void write_data(const test::EmployeeEntryKeyComparator& object,
...
struct hz_serializer<test::TestInvalidWritePortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestInvalidWritePortable& object,
...
struct hz_serializer<test::TestInvalidReadPortable> : public portable_serializer
{
    ...
    static void write_portable(const test::TestInvalidReadPortable& object,
                               portable_writer& writer);
...
struct hz_serializer<test::ObjectCarryingPortable<P>> : public portable_serializer
{
    ...
    static void write_portable(const test::ObjectCarryingPortable<P>& object,
                               portable_writer& writer)
    {
...
struct hz_serializer<test::ChildTemplatedPortable1> : public portable_serializer
{
    ...
    static void write_portable(const test::ChildTemplatedPortable1& object,
                               portable_writer& writer);
...
struct hz_serializer<test::ChildTemplatedPortable2> : public portable_serializer
{
    ...
    static void write_portable(const test::ChildTemplatedPortable2& object,
                               portable_writer& writer);
...
{
    static constexpr int32_t get_type_id() { return 666; }
