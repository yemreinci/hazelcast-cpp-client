...
public:
    ...
    {
    public:
        SamplingEntry(const std::shared_ptr<KS> entry_key, const std::shared_ptr<VS> entry_value)
          : key_(entry_key)
          , value_(entry_value)
        {}
...
protected:
    ...
    {
        const std::shared_ptr<client::internal::eviction::Expirable>& expirable =
          std::dynamic_pointer_cast<client::internal::eviction::Expirable>(value);
