...
private:
    ...
    std::unordered_map<raft_group_id, session_state>::iterator create_new_session(
    ...
    boost::future<client::protocol::ClientMessage> heartbeat(const raft_group_id& group_id,
                                                             int64_t session_id);

    boost::future<client::protocol::ClientMessage> close_session(const raft_group_id& group_id,
                                                                 int64_t session_id);
