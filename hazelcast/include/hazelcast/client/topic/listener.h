...
public:
     ...
     *
     * \warning
     * In order to guarantee message ordering, there is only one thread that invokes the given
     * function. The user should off-load any time consuming operation to another thread.
     *
