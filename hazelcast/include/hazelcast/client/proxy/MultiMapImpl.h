...
protected:
    ...
    boost::future<bool> put(const serialization::pimpl::data& key,
    ...
    boost::future<bool> contains_entry(const serialization::pimpl::data& key,
                                       const serialization::pimpl::data& value);
...
private:
    ...
    {
    public:
        MultiMapEntryListenerToKeyCodec(std::string name,
                                        bool include_value,
    ...
    std::shared_ptr<spi::impl::ListenerMessageCodec> create_multi_map_entry_listener_codec(
      bool include_value);
