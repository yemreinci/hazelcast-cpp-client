...
public:
     ...
     * On client, this method goes to a random member and gets a batch of IDs, which will then be
     * returned locally for limited time. The pre-fetch size and the validity time can be configured
     * for each client and member, see {@code ClientConfig.addFlakeIdGeneratorConfig()} for client
     * config. <p> <b>Note:</b> Values returned from this method may be not strictly ordered.
     *
