...
public:
    ...
    read_result_set(int32_t read_count,
     ...
     */
    int32_t read_count() const { return items_read_count_; }

    const std::vector<typed_data>& get_items() const { return items_; }
     ...
     * @since 3.10
     */
    int64_t get_next_sequence_to_read_from() const { return next_seq_; }
