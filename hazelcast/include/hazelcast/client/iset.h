...
public:
     ...
     *  @param includeValue boolean value representing value should be included in incoming
     * ItemEvent or not.
                                                        ...
                                                        bool include_value)
    {
        std::unique_ptr<impl::item_event_handler<protocol::codec::set_addlistener_handler>>
          itemEventHandler(new impl::item_event_handler<protocol::codec::set_addlistener_handler>(
            get_name(),
