...
/**
 * This is a marker class for Predicate classes. All predicate classes shall extend this class. This
 * class also indicates that a Java implementation is required at the server side.
 */
...
public:
    ...
    template<typename... Args>
    multi_predicate(const std::string attribute_name,
...
public:
     ...
     */
    template<typename T>
    greater_less_predicate(hazelcast_client& client,
...
public:
    ...
    between_predicate(hazelcast_client& client,
                      const std::string& attribute_name,
...
public:
     ...
     */
    like_predicate(hazelcast_client& client,
...
public:
     ...
     * @param expression The expression value to match
     */
    ilike_predicate(hazelcast_client& client,
                    const std::string& attribute,
                    const std::string& expression);
};
...
public:
     ...
     * @param expression The expression value to match
     */
    regex_predicate(hazelcast_client& client,
                    const std::string& attribute,
                    const std::string& expression);
};
...
template<>
struct hz_serializer<query::between_predicate>
  : public BasePredicateSerializer<query::between_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::equal_predicate>
  : public BasePredicateSerializer<query::equal_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::not_equal_predicate>
  : public BasePredicateSerializer<query::not_equal_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::false_predicate>
  : public BasePredicateSerializer<query::false_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::sql_predicate> : public BasePredicateSerializer<query::sql_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::ilike_predicate>
  : public BasePredicateSerializer<query::ilike_predicate>
{
    /**
     * @return class id
     */
...
template<>
struct hz_serializer<query::regex_predicate>
  : public BasePredicateSerializer<query::regex_predicate>
{
    /**
     * @return class id
     */
