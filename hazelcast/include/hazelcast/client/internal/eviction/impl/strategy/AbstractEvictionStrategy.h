...
namespace strategy {
/**
 * Base class for eviction implementations to evict {@link EvictableStore} implementations as
 * specified
...
public:
     ...
     * @param evictionChecker           {@link EvictionChecker} to make a decision about if eviction
     * is required or not. If you want evict anyway, you can use {@link
