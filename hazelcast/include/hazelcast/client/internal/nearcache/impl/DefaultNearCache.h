...
public:
    ...
    /*
                            void put(const std::shared_ptr<KS> &key,
                                ...
                                util::Preconditions::checkNotNull<KS>(key, "key cannot be null on
       put!");
    ...
    */
    ...
    void clear() override { near_cache_record_store_->clear(); }
    ...
    int size() const override { return near_cache_record_store_->size(); }
