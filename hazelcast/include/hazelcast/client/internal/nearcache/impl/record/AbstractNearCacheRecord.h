...
public:
    ...
    AbstractNearCacheRecord(const std::shared_ptr<V>& v, int64_t create_time, int64_t expiry_time)
      : value_(v)
    ...
    int64_t get_creation_time() const override { return creation_time_; }
    ...
    boost::uuids::uuid get_uuid() const { return uuid_; }

    void set_uuid(boost::uuids::uuid uuid) override { AbstractNearCacheRecord::uuid_ = uuid; }

    int64_t get_expiration_time() const override { return expiration_time_; }
    ...
    int64_t get_last_access_time() override { return access_time_; }
    ...
    int32_t get_access_hit() override { return access_hit_; }
    ...
    void increment_access_hit() override { ++access_hit_; }

    void reset_access_hit() override { access_hit_ = 0; }
    ...
    int64_t get_invalidation_sequence() const override { return sequence_; }

    void set_invalidation_sequence(int64_t seq) override { this->sequence_ = seq; }

    bool has_same_uuid(boost::uuids::uuid that_uuid) const override { return uuid_ == that_uuid; }
