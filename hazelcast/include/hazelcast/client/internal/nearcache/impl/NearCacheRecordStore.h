...
public:
     ...
     */
    virtual void put(const std::shared_ptr<K>& key, const std::shared_ptr<V>& value) { assert(0); }
    ...
    */
     ...
     *
     * @return the {@link com.hazelcast.monitor.NearCacheStats} instance to monitor this record
     * store.
     */
