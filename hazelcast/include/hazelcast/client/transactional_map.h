...
public:
     ...
     *
     * The object to be put will be accessible only in the current transaction context till
     ...
     *
     * The object to be set will be accessible only in the current transaction context till
     * transaction is committed.
     *
     ...
     *
     * The object to be replaced will be accessible only in the current transaction context till
     * transaction is committed.
     *
     ...
     *
     * The object to be removed will be removed from only the current transaction context till
     * transaction is committed.
     *
     * @see imap#remove(key)
     */
     ...
     *
     * The object to be deleted will be removed from only the current transaction context till
     * transaction is committed.
     *
     * @see imap#delete(key)
     */
