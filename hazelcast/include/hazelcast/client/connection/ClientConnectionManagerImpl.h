...
private:
    ...
    void handle_successful_auth(const std::shared_ptr<Connection>& connection,
    ...
    util::sync_associative_container<std::unordered_map<address, std::unique_ptr<std::mutex>>>
      conn_locks_;
