...
namespace config {
/**
 * Client connection strategy configuration is used for setting custom strategies and configuring
 * strategy parameters.
 */
...
public:
    ...
    /**
     * Client instance creation won't block on {@link hazelcast_client(ClientConfig &)} if this
     * value is true
