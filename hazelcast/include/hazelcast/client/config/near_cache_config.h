...
public:
    ...
    near_cache_config(int32_t time_to_live_seconds,
     ...
     *
     * @param timeToLiveSeconds The maximum number of seconds for each entry to stay in the Near
     * Cache.
     * @return This Near Cache config instance.
     */
    ...
    friend std::ostream HAZELCAST_API& operator<<(std::ostream& out,
