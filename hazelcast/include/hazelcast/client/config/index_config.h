 ...
 * Hash indexes could be used with equality predicates and have constant search time assuming the
 * hash function of the indexed field disperses the elements properly. <p> Index could be created on
