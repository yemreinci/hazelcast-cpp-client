...
public:
    ...
    /**
     * Returns the number of TTL and max-idle expirations of Near Cache entries owned by this
     * member.
     *
    ...
    /**
     * Returns the timestamp of the last Near Cache key persistence (when the pre-load feature is
     * enabled).
     *
    ...
    /**
     * Returns the duration in milliseconds of the last Near Cache key persistence (when the
    ...
    /**
     * Returns the written bytes of the last Near Cache key persistence (when the pre-load feature
     * is enabled).
     *
    ...
    /**
     * Returns the number of persisted keys of the last Near Cache key persistence (when the
     * pre-load feature is enabled).
     *
    ...
    /**
     * Returns the failure reason of the last Near Cache persistence (when the pre-load feature is
     * enabled).
     *
