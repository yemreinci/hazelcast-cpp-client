 ...
 * @see MultiMap
 */
class HAZELCAST_API transactional_multi_map : public proxy::TransactionalMultiMapImpl
{
...
private:
    transactional_multi_map(const std::string& name, txn::TransactionProxy& transaction_proxy)
